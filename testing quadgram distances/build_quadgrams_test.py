...
def main():
    ...
    data_dir = os.path.join(project_dir, 'testing quadgram distances')
    os.makedirs(data_dir, exist_ok=True)
    
    en_txt_path = os.path.join(data_dir, 'en_corpus_test.txt')
    he_txt_path = os.path.join(data_dir, 'he_corpus_test.txt')
    ...
    en_path = os.path.join(data_dir, 'en_quadgrams_test.json')
    ...
    he_path = os.path.join(data_dir, 'he_quadgrams_test.json')
